$(function() {
	tinyMCE.init({
		...
		pagebreak_separator: '$ext.utils.pageBreak',
		// Example content CSS (should be your site CSS)
		content_css : siteUrl + "/style/style.css",
		...
		external_image_list_url : siteUrl
				+ "/admin/content.mce.images.ajax?id=" + node.id,
	...
	tinyMCE.onAddEditor.add(function() {
		var editor = tinyMCE.get('htmlText');
		if(editor) {
			editor.onLoadContent.add(function() {
				editor.setContent(node.prop('htmlText'));
			});
		}
	});
});
