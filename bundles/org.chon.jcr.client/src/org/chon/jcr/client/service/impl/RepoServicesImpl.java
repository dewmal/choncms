...
public class RepoServicesImpl implements RepoService {
	...
	@Override
	public Status editNode(Session session, String id,
	...
	public Status addFile(Session session, String nodeId, File file, String mimeType) {
		...
		try {
	        ...
	        //TODO: mime
	        if(mimeType != null) {
	        	//MimeTypesFactory.create().getMimeType(file).getName();
	...
	@Override
	public NodeInfo getNode(Session session, String id, int depth,
